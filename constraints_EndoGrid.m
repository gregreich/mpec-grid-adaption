function [c,ceq,g]=constraints_EndoGrid(y,theta,beta,v,nGL,N,xmin,xmax,J,zi,wi,Method)
...
% Residual function
R = @(xi) Spline_Eval(ai,x,xi) - 1/theta2*f(repmat(zi_Laguerre'/theta2,size(xi,1),1),repmat(xi,1,nGL),ai,x)*wi_Laguerre';
